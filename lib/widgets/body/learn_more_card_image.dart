  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        Positioned(
            right: Responsive.isDesktop(context) ? 100 : Responsive.isMobile(context) ? 30 : 80,
            bottom: Responsive.isTablet(context) ? 20 : 0,
            child: Image.asset(AssetPath.debitCardsPhoto, width: MediaQuery.of(context).size.width*0.42))
      ],
    );
  }
}
